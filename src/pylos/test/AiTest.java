...
public class AiTest extends PylosTestCase {
	...
	public void testEvaluate() {
		...
		// assertEquals(-80, EvaluateGame.countBallInHandPoint(s));
	}
	...
	public void testEvaluate3() {
		...
		GameState gss = i.next();
		gss.generatePosibleMoves();
		i = gss.iterator();
		gss = i.next();
		gss.generatePosibleMoves();
		i = gss.iterator();
		...
		i = gss.iterator();
		gss = i.next();
		gss.state.printState();

		EvaluateGame.evaluate(gss);
		assertEquals(0, gss.score);
	}
	...
	public void testMount() {
		 ...
		 */
		State s = new State();
		MoveBall m = new MountBall(Position.at(1, 0, 1), Position.at(2, 2, 0));
		s = m.doMove(s);
	...
	public void testStateCopy() {
		...
		MoveBall m = new Remove(Position.at(2, 1, 0));
		s2 = m.doMove(s);
		// s2.printState();
		s2.switchPlayer();
	...
	public void testGenerateMove2() {
		...
		GameState gs = new GameState();
		gs.generatePosibleMoves();
		for (MoveBall m : gs.possibleMoves) {
